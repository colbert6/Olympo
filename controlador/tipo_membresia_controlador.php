...
class tipo_membresia_controlador extends controller {
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->_model = $this->cargar_modelo('tipo_membresia');
    }

    public function index() {
        $this->_vista->titulo = 'Lista de Tipos de Membresia';
    ...
    public function nuevo() {
        ...
        $this->_vista->titulo = 'Registrar Tipo de Membresia';
        $this->_vista->action = BASE_URL . 'tipo_membresia/nuevo';
    ...
    public function editar($id) {
        ...
        $this->_vista->titulo = 'Actualizar Tipo de Membresia';
        $this->_vista->action = BASE_URL . 'tipo_membresia/editar/'.$id;
        $this->_vista->setJs(array('funciones_form'));
        $this->_vista->renderizar('form');
    }
