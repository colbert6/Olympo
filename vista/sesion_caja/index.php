         ...
         <tbody>
            ...
            <tr>
                ...
                <td><!-- icon-stop -->
                    ...
                    <?php }else{?>
                            <a href="javascript:void(0)" onclick="apertura('<?php echo $this->e_caja[$i]['ID_CAJA']?>')" class="btn btn-success btn-minier" id="mostrarVtnApertura"><i class="icon-play icon-white"></i>&nbsp;&nbsp;&nbsp;Aperturar</a>
                    <?php }?>
