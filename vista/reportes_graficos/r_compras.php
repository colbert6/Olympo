...
$chart->title->text = utf8_decode("Compras Mensuales de Aquinos Grafica Integral");

$chart->xAxis->categories = array("Ene", "Feb", "Mar", "Abr", "May", "Jun",
                                  "Jul", "Aug", "Sep", "Oct", "Nov", "Dec");

$chart->yAxis->min = 0;
$chart->yAxis->title->text = "Compras en S/.";
...
$chart->series[] = array('name' => "Dinero Por Compras por Mes",
