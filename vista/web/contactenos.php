   <div class="row">
                ...
                <div class="row clearfix col-md-12">
                    <div class=" col-md-5 left col-md-push-1 ">
                        ...
                        <form id="formu" action="<?php echo BASE_URL ?>web/contactenos" method="post"> <!-- formulario -->
                            <fieldset>
                              <input type="hidden" name="guardar" id="guardar" value="1"/>
                                <div class="col-md-12 form-group">
                                    <label for="nombre" class="control-label">Nombres:<span>*</span></label>
                                    <input type="text" id="nombre" class="form-control input-sm" name="nombre" placeholder="nombre" required>
                                </div>
                                <div class="col-md-12 form-group">
                                    <label for="telefono" class="control-label">Teléfono:</label>
                                    <input type="tel" onkeypress="return soloNumeros(event)" id="telefono" class="form-control input-sm" name="telefono" placeholder="Telefono">
                                </div>
                                <div class="col-md-12 form-group">
