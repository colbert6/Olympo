...
<form method="post" action="<?php if(isset ($this->action))echo $this->action ?>" id="frm" enctype="multipart/form-data">
    ...
    <input type="hidden" name="id_web_servicio" id="id_web_servicio"
            value="<?php if(isset ($this->datos[0]['ID_WEB_SERVICIO']))echo $this->datos[0]['ID_WEB_SERVICIO'] ?>"/>
    <table align="center" cellpadding="10">
        ...
        <tr>
            ...
            <div id="imagen_subida" style="text-align: center">
                <img width="150px" height="100px" src="<?php echo BASE_URL ?>lib/img/servicio/<?php echo strtolower($this->datos[0]['IMAGEN']) ?>" />
                <br><br>
        ...
        <tr>
            <td colspan="2" align="center">
                ...
                <a href="<?php echo BASE_URL ?>web_servicio" class="btn btn-info">Cancelar</a></p>
            </td>
        </tr>
    </table>
</form>
