...
$(document).ready(function(){
    ...
    $("#grilla").addClass('table-responsive');
  ...
  $("#nav > li > a").on('click',function(e){
      ...
      if(!$(this).hasClass("subdrop")) {
        ...
        $(".lista_menu").slideUp(350);        
        $(".seleccion > span > i").removeClass('icon-chevron-down');
        $(".seleccion > span > i").addClass('icon-chevron-right');
        $(".opcion_menu").removeClass("subdrop seleccion");
        
        
        // open our new menu and add the open class
        $(this).next("ul").slideDown(350);
        $(this).addClass("subdrop seleccion");
        $(".seleccion > span > i").removeClass('icon-chevron-right');
        $(".seleccion > span > i").addClass('icon-chevron-down');
      }
